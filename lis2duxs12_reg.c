...
int32_t lis2duxs12_init_set(const stmdev_ctx_t *ctx)
{
  ...
  {
    (void)memset(ctx->priv_data, 0, sizeof(lis2duxs12_priv_t));
  }
...
{
  int32_t ret = lis2duxs12_enter_deep_power_down(ctx, 1);
...
{
  lis2duxs12_status_register_t status_register = {0};
  lis2duxs12_ctrl1_t ctrl1 = {0};
  lis2duxs12_ctrl4_t ctrl4 = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_emb_func_status_mainpage_t status = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_ctrl3_t ctrl3 = {0};
  lis2duxs12_ctrl5_t ctrl5 = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_fifo_ctrl_t fifo_ctrl = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_status_register_t status = {0};
  int32_t ret = 0;
                               ...
                               lis2duxs12_xl_data_t *data)
{
  ...
  for (i = 0U; i < 3U; i++)
  {
    data->raw[i] = (int16_t)(buff[j] | (uint16_t)buff[j + 1U] << 8);
    j += 2U;
    switch (md->fs)
    {
      case LIS2DUXS12_2g:
                                 ...
                                 lis2duxs12_outt_data_t *data)
{
  ...
  data->heat.raw = (int16_t)(buff[0] | ((uint16_t)buff[1U] << 8));
                                    ...
                                    lis2duxs12_ah_qvar_data_t *data)
{
  ...
  ret = lis2duxs12_read_reg(ctx, LIS2DUXS12_OUT_T_AH_QVAR_L - 1U, buff, 3);
  ...
  data->raw = (int16_t)(buff[1U] | (uint16_t)buff[2U] << 8);
...
{
  lis2duxs12_ctrl3_t ctrl3 = {0};
  lis2duxs12_wake_up_dur_t wkup_dur = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_self_test_t self_test = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    self_test.st = (uint8_t) val & 0x03U;
...
{
  lis2duxs12_i3c_if_ctrl_t i3c_cfg = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    i3c_cfg.bus_act_sel = (uint8_t)val->bus_act_sel & 0x03U;
...
{
  lis2duxs12_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_page_address_t page_address = {0};
  lis2duxs12_page_sel_t page_sel = {0};
  lis2duxs12_page_rw_t page_rw = {0};
  uint8_t msb = 0;
  uint8_t lsb = 0;
  int32_t ret = 0;
  uint8_t i = 0;
...
{
  lis2duxs12_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = 0;
...
int32_t lis2duxs12_int_pin_polarity_set(const stmdev_ctx_t *ctx, lis2duxs12_int_pin_polarity_t val)
{
  ...
  if (ret == 0)
  {
    pin_ctrl.h_lactive = (uint8_t)val & 0x01U;
    ret = lis2duxs12_write_reg(ctx, LIS2DUXS12_PIN_CTRL, (uint8_t *)&pin_ctrl, 1);
  }
...
int32_t lis2duxs12_spi_mode_set(const stmdev_ctx_t *ctx, lis2duxs12_spi_mode val)
{
  ...
  if (ret == 0)
  {
    pin_ctrl.sim = (uint8_t)val & 0x01U;
    ret = lis2duxs12_write_reg(ctx, LIS2DUXS12_PIN_CTRL, (uint8_t *)&pin_ctrl, 1);
  }
...
{
  lis2duxs12_ctrl1_t ctrl1 = {0};
  lis2duxs12_ctrl2_t ctrl2 = {0};
  lis2duxs12_md1_cfg_t md1_cfg = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_emb_func_int1_t emb_func_int1 = {0};
  lis2duxs12_md1_cfg_t md1_cfg = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_ctrl3_t ctrl3 = {0};
  lis2duxs12_md2_cfg_t md2_cfg = {0};
  int32_t ret = 0;
...
int32_t lis2duxs12_emb_pin_int2_route_set(const stmdev_ctx_t *ctx,
                                          const lis2duxs12_emb_pin_int_route_t *val)
{
  lis2duxs12_emb_func_int2_t emb_func_int2 = {0};
  lis2duxs12_md2_cfg_t md2_cfg = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_interrupt_cfg_t interrupt_cfg = {0};
  int32_t ret = 0;
...
int32_t lis2duxs12_fifo_mode_set(const stmdev_ctx_t *ctx, lis2duxs12_fifo_mode_t val)
{
  lis2duxs12_ctrl4_t ctrl4 = {0};
  lis2duxs12_fifo_ctrl_t fifo_ctrl = {0};
  lis2duxs12_fifo_wtm_t fifo_wtm = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    ...
    /* Set xl_only_fifo */
    fifo_wtm.xl_only_fifo = val.xl_only & 0x01U;

    fifo_ctrl.cfg_chg_en = val.cfg_change_in_fifo & 0x01U;
...
{
  lis2duxs12_fifo_batch_dec_t fifo_batch = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    fifo_batch.dec_ts_batch = (uint8_t)val.dec_ts & 0x03U;
    fifo_batch.bdr_xl = (uint8_t)val.bdr_xl & 0x07U;
...
int32_t lis2duxs12_fifo_stop_on_wtm_set(const stmdev_ctx_t *ctx, lis2duxs12_fifo_event_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl.stop_on_fth = (val == LIS2DUXS12_FIFO_EV_WTM) ? 1U : 0U;
    ret += lis2duxs12_write_reg(ctx, LIS2DUXS12_FIFO_CTRL, (uint8_t *)&fifo_ctrl, 1);
  }
...
int32_t lis2duxs12_fifo_stop_on_wtm_get(const stmdev_ctx_t *ctx, lis2duxs12_fifo_event_t *val)
{
  ...
  if (ret == 0)
  {
    *val = (fifo_ctrl.stop_on_fth == 1U) ? LIS2DUXS12_FIFO_EV_WTM : LIS2DUXS12_FIFO_EV_FULL;
  }
...
{
  lis2duxs12_fifo_status1_t fifo_status1 = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_fifo_data_out_tag_t fifo_tag = {0};
  int32_t ret = 0;
                                 ...
                                 lis2duxs12_fifo_data_t *data)
{
  ...
  {
    case (uint8_t)LIS2DUXS12_XL_ONLY_2X_TAG:
    case (uint8_t)LIS2DUXS12_XL_ONLY_2X_TAG_2ND:
      ...
      break;
    case (uint8_t)LIS2DUXS12_XL_AND_QVAR:
    case (uint8_t)LIS2DUXS12_XL_TEMP_TAG:
      ret = lis2duxs12_fifo_out_raw_get(ctx, fifo_raw);
      if (ret != 0)
      {
        return ret;
      ...
      if (fmd->xl_only == 0x0U)
      {
        ...
        data->xl[0].raw[0] = (int16_t)((fifo_raw[0] | ((uint16_t)fifo_raw[1] << 8)) << 4);
        data->xl[0].raw[1] = (int16_t)(((fifo_raw[1] >> 4) | ((uint16_t) fifo_raw[2] << 4)) << 4);
        data->xl[0].raw[2] = (int16_t)((fifo_raw[3] | ((uint16_t)fifo_raw[4] << 8)) << 4);

        data->heat.raw = (int16_t)(((fifo_raw[4] >> 4) + ((uint16_t)fifo_raw[5] << 4)) << 4);
      ...
      else
      {
        ...
        data->xl[0].raw[0] = (int16_t)(fifo_raw[0] | ((uint16_t)fifo_raw[1] << 8));
        data->xl[0].raw[1] = (int16_t)(fifo_raw[2] | ((uint16_t)fifo_raw[3] << 8));
        data->xl[0].raw[2] = (int16_t)(fifo_raw[4] | ((uint16_t)fifo_raw[5] << 8));
      }
      break;
    case (uint8_t)LIS2DUXS12_TIMESTAMP_TAG:
      ret = lis2duxs12_fifo_out_raw_get(ctx, fifo_raw);
      if (ret != 0)
      {
        return ret;
    ...
    case (uint8_t)LIS2DUXS12_STEP_COUNTER_TAG:
      ret = lis2duxs12_fifo_out_raw_get(ctx, fifo_raw);
      if (ret != 0)
      {
        return ret;
    ...
    case (uint8_t)LIS2DUXS12_FIFO_EMPTY:
    default:
      /* do nothing */
      break;
  }
...
{
  lis2duxs12_ah_qvar_cfg_t ah_qvar_cfg = {0};
  int32_t ret = 0;

  ret = lis2duxs12_read_reg(ctx, LIS2DUXS12_AH_QVAR_CFG, (uint8_t *)&ah_qvar_cfg, 1);
  if (ret == 0)
  {
    ah_qvar_cfg.ah_qvar_gain = (uint8_t)val.ah_qvar_gain & 0x03U;
    ah_qvar_cfg.ah_qvar_c_zin = (uint8_t)val.ah_qvar_zin & 0x03U;
    ah_qvar_cfg.ah_qvar_notch_cutoff = (uint8_t)val.ah_qvar_notch & 0x01U;
    ah_qvar_cfg.ah_qvar_notch_en = val.ah_qvar_notch_en & 0x01U;
    ah_qvar_cfg.ah_qvar_en = val.ah_qvar_en & 0x01U;
...
{
  lis2duxs12_emb_func_en_a_t emb_func_en_a = {0};
  lis2duxs12_emb_func_en_b_t emb_func_en_b = {0};
  lis2duxs12_emb_func_fifo_en_t emb_func_fifo_en = {0};
  lis2duxs12_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_emb_func_src_t emb_func_src = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_pedo_deb_steps_conf_t pedo_deb_steps_conf = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_ctrl1_t ctrl1 = {0};
  lis2duxs12_smart_power_ctrl_t smart_power_ctrl = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_wake_up_dur_t wake_up_dur = {0};
  lis2duxs12_free_fall_t free_fall = {0};
  int32_t ret = 0;
...
int32_t lis2duxs12_sixd_config_set(const stmdev_ctx_t *ctx, lis2duxs12_sixd_config_t val)
{
  ...
  if (ret == 0)
  {
    sixd.d4d_en = ((uint8_t)val.mode) & 0x01U;
    sixd.d6d_ths = ((uint8_t)val.threshold) & 0x03U;
...
{
  lis2duxs12_wake_up_ths_t wup_ths = {0};
  lis2duxs12_wake_up_dur_t wup_dur = {0};
  lis2duxs12_wake_up_dur_ext_t wup_dur_ext = {0};
  lis2duxs12_interrupt_cfg_t int_cfg = {0};
  lis2duxs12_ctrl1_t ctrl1 = {0};
  lis2duxs12_ctrl4_t ctrl4 = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    ...
    wup_dur_ext.wu_dur_extended = ((uint8_t)val.wake_dur >> 4) & 0x01U;
    wup_dur.sleep_dur = val.sleep_dur & 0x0FU;

    int_cfg.wake_ths_w = val.wake_ths_weight;
    wup_ths.wk_ths = val.wake_ths & 0x3FU;
    wup_ths.sleep_on = (uint8_t)val.wake_enable & 0x01U;
    ctrl4.inact_odr = (uint8_t)val.inact_odr & 0x03U;
...
{
  lis2duxs12_tap_cfg0_t tap_cfg0 = {0};
  lis2duxs12_tap_cfg1_t tap_cfg1 = {0};
  lis2duxs12_tap_cfg2_t tap_cfg2 = {0};
  lis2duxs12_tap_cfg3_t tap_cfg3 = {0};
  lis2duxs12_tap_cfg4_t tap_cfg4 = {0};
  lis2duxs12_tap_cfg5_t tap_cfg5 = {0};
  lis2duxs12_tap_cfg6_t tap_cfg6 = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    tap_cfg0.axis = (uint8_t)val.axis & 0x03U;
    tap_cfg0.invert_t = val.inverted_peak_time & 0x1FU;
    tap_cfg1.pre_still_ths = val.pre_still_ths & 0x0FU;
    tap_cfg3.post_still_ths = val.post_still_ths & 0x0FU;
    tap_cfg1.post_still_t = val.post_still_time & 0xFU;
    tap_cfg2.post_still_t = (val.post_still_time >> 4) & 0x03U;
    tap_cfg2.wait_t = val.shock_wait_time & 0x3FU;
    tap_cfg3.latency_t = val.latency & 0x0FU;
    tap_cfg4.wait_end_latency = val.wait_end_latency & 0x01U;
    tap_cfg4.peak_ths = val.peak_ths & 0x3FU;
    tap_cfg5.rebound_t = val.rebound & 0x1FU;
    tap_cfg5.single_tap_en = val.single_tap_on & 0x01U;
    tap_cfg5.double_tap_en = val.double_tap_on & 0x01U;
    tap_cfg5.triple_tap_en = val.triple_tap_on & 0x01U;
    tap_cfg6.pre_still_st = val.pre_still_start & 0x0FU;
    tap_cfg6.pre_still_n = val.pre_still_n & 0x0FU;
...
int32_t lis2duxs12_tap_config_get(const stmdev_ctx_t *ctx, lis2duxs12_tap_config_t *val)
{
  ...
  if (ret == 0)
  {
    ...
    val->inverted_peak_time = tap_cfg0.invert_t & 0x1FU;
    val->pre_still_ths = tap_cfg1.pre_still_ths & 0x0FU;
    val->post_still_ths = tap_cfg3.post_still_ths & 0x0FU;
    val->post_still_time = (uint8_t)((tap_cfg2.post_still_t << 4) | tap_cfg1.post_still_t) & 0x3FU;
    val->shock_wait_time = tap_cfg2.wait_t & 0x3FU;
    val->latency = tap_cfg3.latency_t & 0x0FU;
    val->wait_end_latency = tap_cfg4.wait_end_latency & 0x01U;
    val->peak_ths = tap_cfg4.peak_ths & 0x3FU;
    val->rebound = tap_cfg5.rebound_t & 0x1FU;
    val->single_tap_on = tap_cfg5.single_tap_en & 0x01U;
    val->double_tap_on = tap_cfg5.double_tap_en & 0x01U;
    val->triple_tap_on = tap_cfg5.triple_tap_en & 0x01U;
    val->pre_still_start = tap_cfg6.pre_still_st & 0x0FU;
    val->pre_still_n = tap_cfg6.pre_still_n & 0x0FU;
  }
...
int32_t lis2duxs12_timestamp_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    int_cfg.timestamp_en = (uint8_t)val & 0x01U;
    ret = lis2duxs12_write_reg(ctx, LIS2DUXS12_INTERRUPT_CFG, (uint8_t *)&int_cfg, 1);
  }
...
int32_t lis2duxs12_long_cnt_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                                uint8_t *val)
{
  lis2duxs12_emb_func_status_t emb_func_status = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_fsm_odr_t fsm_odr_reg = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    fsm_odr_reg.fsm_odr = (uint8_t)val & 0x07U;
...
{
  lis2duxs12_emb_func_init_b_t emb_func_init_b = {0};
  int32_t ret = 0;
...
{
  lis2duxs12_emb_func_fifo_en_t fifo_reg = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    fifo_reg.fsm_fifo_en = val & 0x01U;
...
{
  lis2duxs12_emb_func_en_a_t emb_en_a = {0};
  lis2duxs12_emb_func_en_b_t emb_en_b = {0};
  int32_t ret = 0;
...
int32_t lis2duxs12_mlc_fifo_en_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    fifo_reg.mlc_fifo_en = val & 0x01U;
    ret += lis2duxs12_write_reg(ctx, LIS2DUXS12_EMB_FUNC_FIFO_EN, (uint8_t *)&fifo_reg, 1);
  }
